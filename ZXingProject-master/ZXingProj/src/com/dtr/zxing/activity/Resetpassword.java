...
public class Resetpassword {
	//private static String url="http://10.0.2.2:8080/SendData/DataServer";  
			...
			//private static String url="http://10.0.2.2:8080/ChangePassword/ChangePasswordservlet";
	private static String url="http://118.89.45.193:8080/ChangePassword/ChangePasswordservlet";	    
	public static final int SEND_SUCCESS=0x123;  
		    public static final int SEND_FAIL=0x124;  
		    InputStream inputStream=null;
		    private Handler handler;  
		    public Resetpassword(Handler handler) {  
		     ...
		     * @param pwd  密码 
		     */  
		    public void Resetpassword(String password,String phonenumber) {  
