...
public class RecyleUserFromServer implements Callable{
	private String url="http://118.89.45.193:8080/BookLoginin/BookLogininservlet"; 
	//private String url="http://10.0.2.2:8080/BookLoginin/BookLogininservlet"; 
    ...
    String user="";
    String password="";
    public RecyleUserFromServer(Handler handler,String user,String password) {   
