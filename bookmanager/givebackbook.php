...
<form action="showgivebackbook1.php" method="post" style="clear:both;">
<div style="clear:both;">
<p style="font-size:20px; float:left;margin-top:20px" id="notice">当日书本<span style="text-decoration:underline">归还</span>人次查询:</p>
...
<input type="submit" value="开始查询" id="submit1" style="float:left;margin-left:30px;margin-top:20px;width:80px;height:25px;"/>
 ...
 <form action="showgivebackbook.php" method="post" style="clear:both;">
<div style="clear:both;">
<p style="font-size:20px; clear:both;" id="notice">多日书本<span style="text-decoration:underline">归还</span>人次查询:</p>
