...
(function ($) {
    ...
    Jconfirm.prototype = {
        ...
        _buildHTML: function () {
            ...
            this.$b.height(H*0.17);
			this.$b.width(W*0.6);
			this.$b.css("font-size",  H*0.025 );
			this.$b.css("margin-left",  W*0.2 );
        ...
        _setButtons: function () {
            ...
            if (this.confirmButton && $.trim(this.confirmButton) !== '') {
				...
				this.$confirmButton.height(H*0.04);
				this.$confirmButton.width(W*0.25);
				this.$confirmButton.css("font-size",  H*0.025 );
				this.$confirmButton.css("padding",  "0px");
				this.$confirmButton.css("background",  "#FFF");
				this.$confirmButton.css("color",  "green");
				//this.$confirmButton.css("margin-top",  H*0.05 );
				this.$confirmButton.css({"float":"left",  "display":"block"} );
			}
            if (this.cancelButton && $.trim(this.cancelButton) !== '') {
				...
				this.$cancelButton.height(H*0.04);
				this.$cancelButton.width(W*0.25);
				this.$cancelButton.css("font-size",  H*0.025 );
				this.$cancelButton.css("padding",  "0px");
				this.$cancelButton.css("background",  "#FFF");
				//this.$cancelButton.css("margin-top",  H*0.05 );
				this.$cancelButton.css({"float":"left",  "display":"block"} );
			}
